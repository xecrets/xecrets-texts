...
/// <summary>
/// Duplicate of Xecrets.Ez.Models.Models.Is, kept here so that Xecrets.Texts has no dependency on
/// Xecrets.Ez.Models. Used by <see cref="Extensions"/> to determine the site to link to.
/// </summary>
