...
public class Texts
{
    ...
    public static string ButtonAbout => T[nameof(Resources.MenuAbout)].StripAccelerator();
    public static string ButtonCancel => T[nameof(Resources.ButtonCancel)];
    public static string ButtonClose => T[nameof(Resources.MenuClose)].StripAccelerator();
    ...
    public static string ButtonDecrypt => T[nameof(Resources.MenuDecrypt)].StripAccelerator().StripEllipsis();
    public static string ButtonDecryptMore => T[nameof(Resources.MenuDecrypt)].StripAccelerator();
    public static string ButtonEdit => T[nameof(Resources.MenuEdit)].StripAccelerator();
    public static string ButtonEncrypt => T[nameof(Resources.MenuEncrypt)].StripAccelerator().StripEllipsis();
    public static string ButtonEncryptMore => T[nameof(Resources.MenuEncrypt)].StripAccelerator();
    public static string ButtonExit => T[nameof(Resources.MenuExit)].StripAccelerator();
    public static string ButtonFree => T[nameof(Resources.ButtonFree)];
    public static string ButtonGo => T[nameof(Resources.ButtonGo)];
    public static string ButtonHelp => T[nameof(Resources.MenuHelp)].StripAccelerator();
    ...
    public static string ButtonOpenMore => T[nameof(Resources.MenuOpen)].StripAccelerator();
    public static string ButtonPaste => T[nameof(Resources.MenuPaste)].StripAccelerator();
    ...
    public static string ButtonWipe => T[nameof(Resources.MenuWipe)].StripAccelerator().StripEllipsis();
    ...
    public static string DialogTextClearRecent => T[nameof(Resources.MenuClearRecent)].StripAccelerator().StripEllipsis();
    ...
    public static string DialogTitleChangeEmail => T[nameof(Resources.MenuChangeEmail)].StripAccelerator().StripEllipsis();
    public static string DialogTitleChangePassword => T[nameof(Resources.MenuChangePassword)].StripAccelerator().StripEllipsis();
    public static string DialogTitleClearPasswords => T[nameof(Resources.MenuClearPasswords)].StripAccelerator().StripEllipsis();
    public static string DialogTitleCombineShares => T[nameof(Resources.MenuCombineShares)].StripAccelerator().StripEllipsis();
    public static string DialogTitleCreateShares => T[nameof(Resources.MenuCreateShares)].StripAccelerator().StripEllipsis();
    public static string DialogTitleEncryptCopyFor => T[nameof(Resources.MenuEncryptCopyFor)].StripAccelerator().StripEllipsis();
    public static string DialogTitleEncryptDecryptText => T[nameof(Resources.MenuEncryptDecryptText)].StripAccelerator().StripEllipsis();
    public static string DialogTitleFetchLicense => T[nameof(Resources.DialogTitleFetchLicense)];
    public static string DialogTitleLoadShares => T[nameof(Resources.MenuLoadShares)].StripAccelerator().StripEllipsis();
    public static string DialogTitleRandomRename => T[nameof(Resources.MenuRandomRename)].StripAccelerator().StripEllipsis();
    ...
    public static string DialogTitleSuggestPassword => T[nameof(Resources.MenuSuggestPassword)].StripAccelerator().StripEllipsis();
    ...
    public static string LabelCancel => T[nameof(Resources.ButtonCancel)].StripAccelerator();
    public static string LabelCreate => T[nameof(Resources.ButtonCreate)].StripAccelerator();
    ...
    public static string LabelNo => T[nameof(Resources.ButtonNo)].StripAccelerator();
    public static string LabelOk => T[nameof(Resources.ButtonOk)].StripAccelerator();
    public static string LabelTheSecret => T[nameof(Resources.LabelTheSecret)];
    public static string LabelYes => T[nameof(Resources.ButtonYes)].StripAccelerator();
    ...
    public static string MenuHelpMore => T[nameof(Resources.MenuHelp)] + "…";
    ...
    public static string ToolTipClipboardLicense => T[nameof(Resources.MenuClipboardLicense)].StripAccelerator();
